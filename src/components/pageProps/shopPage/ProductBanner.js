  ...
  return (
    <div className="w-full flex flex-col md:flex-row md:items-center justify-between">
      <div className='flex items-center gap-4'>
        <span className={`${girdViewActive ? 'bg-primeColor text-white' : 'border-[1px] border-gray-300 text-[#737373]'} w-8 h-8 text-lg flex items-center justify-center cursor-pointe gridView`}>
          <BsGridFill />
        </span>
        <span className={`${listViewActive ? 'bg-primeColor text-white' : 'border-[1px] border-gray-300 text-[#737373]'} w-8 h-8 text-lg flex items-center justify-center cursor-pointe listView`}>
          <ImList />
        </span>
      </div>
      ...
      <div className='flex items-center gap-2 md:gap-6 mt-4 md:mt-0'>
        <div className='flex items-center gap-2 relative text-base text-[#767676]'>
